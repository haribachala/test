...
public class RetrieveRegulatoryService {


    public static void main(String[] args) throws Exception {
        List<String> requestsLists = RetrieveRegulatoryService.getRequest();
        RetrieveRegulatoryService.writeRequestToFile(requestsLists);
    }
    ...
    private static List<String> getRequest() throws Exception {
        ...
        while ((currentLine = br.readLine()) != null) {
            ...
            if (currentLine.indexOf("[http://ngs-prod-edc.tshhosting.com:8200/mr/RetrieveRegulatoryService/v1/regulatory/") > -1){
    ...
    static  private void writeRequestToFile(List<String> requests) throws Exception {
        String file = "C:\\Users\\U6015446\\Desktop\\Logs\\ServiceRequests\\RetrieveRegulatoryService.txt";
