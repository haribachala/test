...
public class Export_GRC {



    public static void main(String[] args) throws Exception {
        List<String> requestsLists = Export_GRC.getRequest();
        Export_GRC.writeRequestToFile(requestsLists);
    }
    ...
    private static List<String> getRequest() throws Exception {
        ...
        while ((currentLine = br.readLine()) != null) {
            ...
            if (currentLine.indexOf("[http://ngs-mwb-prod-edc.int.thomsonreuters.com:8320/ExportService/regulatory/v1/globalRegComparison/") > -1){
    ...
    static  private void writeRequestToFile(List<String> requests) throws Exception {
        String file = "C:\\Users\\U6015446\\Desktop\\Logs\\ServiceRequests\\Export_GRC.txt";
