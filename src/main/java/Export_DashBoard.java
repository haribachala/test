...
public class Export_DashBoard {



    public static void main(String[] args) throws Exception {
        List<String> requestsLists = Export_DashBoard.getRequest();
        Export_DashBoard.writeRequestToFile(requestsLists);
    }
    ...
    private static List<String> getRequest() throws Exception {
        ...
        while ((currentLine = br.readLine()) != null) {
            ...
            if (currentLine.indexOf("[http://ngs-mwb-prod-edc.int.thomsonreuters.com:8348/ExportDashboard/") > -1){
    ...
    static  private void writeRequestToFile(List<String> requests) throws Exception {
        String file = "C:\\Users\\U6015446\\Desktop\\Logs\\ServiceRequests\\Export_DashBoard.txt";
