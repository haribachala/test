...
public class Export_Decoupled {

        public static void main(String[] args) throws Exception {
        List<String> requestsLists = Export_Decoupled.getRequest();
        Export_Decoupled.writeRequestToFile(requestsLists);
    }
    ...
    static  private void writeRequestToFile(List<String> requests) throws Exception {
        String file = "C:\\Users\\U6015446\\Desktop\\Logs\\ServiceRequests\\Export_Decoupled.txt";
