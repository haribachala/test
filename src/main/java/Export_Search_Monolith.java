...
public class Export_Search_Monolith {

        public static void main(String[] args) throws Exception {
            List<String> requestsLists = main.java.Export_Search_Monolith.getRequest();
         //   main.java.Export_Search_Monolith.writeRequestToFile(requestsLists);
        }
        ...
        private static List<String> getRequest() throws Exception {
            ...
            while ((currentLine = br.readLine()) != null) {
                ...
                if (currentLine.indexOf("<soap:Body><ns2:asyncExportToBizint xmlns:ns2=\"http://exportsearch.v3.soap.service.soaservices.stack.soa.ls.thomson.com/\"") > -1){
                    int urlIndex  = currentLine.indexOf("<soap:Body><ns2:asyncExportToBizint xmlns:ns2=\"http://exportsearch.v3.soap.service.soaservices.stack.soa.ls.thomson.com/\"");
        ...
        static  private void writeRequestToFile(List<String> requests) throws Exception {
            String file = "C:\\Users\\U6015446\\Desktop\\Logs\\ServiceRequests\\Export_asyncExportToBizint_Search_Monolith.txt";
