...
public class Dashboard_Persistence {
    public static void main(String[] args) throws Exception {
        List<String> requestsLists = Dashboard_Persistence.getRequest();
        Dashboard_Persistence.writeRequestToFile(requestsLists);
    }
    ...
    private static List<String> getRequest() throws Exception {
        ...
        while ((currentLine = br.readLine()) != null) {
            ...
            if (currentLine.indexOf("[http://ngs-mwb-prod-edc.int.thomsonreuters.com:8349/DashboardPersistence/v1/dashboard/") > -1){
    ...
    static  private void writeRequestToFile(List<String> requests) throws Exception {
        String file = "C:\\Users\\U6015446\\Desktop\\Logs\\ServiceRequests\\Dashboard_Persistence.txt";
