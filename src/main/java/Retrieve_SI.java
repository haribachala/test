...
public class Retrieve_SI {

    public static void main(String[] args) throws Exception {
        List<String> requestsLists = Retrieve_SI.getRequest();
         Retrieve_SI.writeRequestToFile(requestsLists);
    }
    ...
    private static List<String> getRequest() throws Exception {
        ...
        while ((currentLine = br.readLine()) != null) {
            ...
            if (currentLine.indexOf("[http://ngs-mwb-prod-edc.int.thomsonreuters.com:8347/mr/RetrieveSIService/rest/") > -1){
    ...
    static  private void writeRequestToFile(List<String> requests) throws Exception {
        String file = "C:\\Users\\U6015446\\Desktop\\Logs\\ServiceRequests\\Retrieve_SI.txt";
