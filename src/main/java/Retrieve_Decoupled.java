...
public class Retrieve_Decoupled {



    public static void main(String[] args) throws Exception {
        List<String> requestsLists = Retrieve_Decoupled.getRequest();
        Retrieve_Decoupled.writeRequestToFile(requestsLists);
    }
    ...
    private static List<String> getRequest() throws Exception {
        ...
        while ((currentLine = br.readLine()) != null) {
            ...
            if (currentLine.indexOf("[http://ngs-mwb-prod-edc.int.thomsonreuters.com:8346/mr/RetrieveService/rest/") > -1){
    ...
    static  private void writeRequestToFile(List<String> requests) throws Exception {
        String file = "C:\\Users\\U6015446\\Desktop\\Logs\\ServiceRequests\\Retrieve_Decoupled.txt";
