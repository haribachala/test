...
public class Export_Search_Decoupled {

        public static void main(String[] args) throws Exception {
        List<String> requestsLists = Export_Search_Decoupled.getRequest();
        Export_Search_Decoupled.writeRequestToFile(requestsLists);
    }
        ...
        while ((currentLine = br.readLine()) != null) {
            ...
            if (currentLine.indexOf("[http://ngs-mwb-prod-edc.int.thomsonreuters.com:8330/") > -1){
    ...
    static  private void writeRequestToFile(List<String> requests) throws Exception {
        String file = "C:\\Users\\U6015446\\Desktop\\Logs\\ServiceRequests\\Export_Search_Decoupled.txt";
